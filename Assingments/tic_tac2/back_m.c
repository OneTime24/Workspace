...
//         }
//         for (int i = 0; winu[i] != '\0'; i++) {
//             if (winu[i] >= 'a' && winu[i] <= 'z') winu[i] -= 32;
//         }

//         // Compare with searchName
//         if ((strcmp(p1u, searchName) == 0) ||
//             (strcmp(p2u, searchName) == 0) ||
//             (strcmp(winu, searchName) == 0)) {
...
// case 3: {
//     FILE *fp = fopen("games_log.txt", "r");
//     if (!fp) {
//         printf("No history file found.\n");
//         break;
//     }

//     char p1[50], p2[50], win[50];
//     int turns;
...
//     while (fscanf(fp, "%s %s %s %d", p1, p2, win, &turns) != EOF) {
